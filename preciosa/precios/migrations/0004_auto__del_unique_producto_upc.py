...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Producto', fields ['upc']
        db.delete_unique(u'precios_producto', ['upc'])


    def backwards(self, orm):
        # Adding unique constraint on 'Producto', fields ['upc']
        db.create_unique(u'precios_producto', ['upc'])
    ...
    models = {
        ...
        u'precios.producto': {
            ...
            'upc': ('django.db.models.fields.CharField', [], {'max_length': '13', 'null': 'True', 'blank': 'True'})
        },
        u'precios.sucursal': {
